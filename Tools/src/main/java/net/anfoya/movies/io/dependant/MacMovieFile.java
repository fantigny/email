...
public class MacMovieFile extends AbstractMovieFile implements MovieFile {
	private static final Logger LOGGER = LoggerFactory.getLogger(MacMovieFile.class);

	private static String mountPoint = null;

	public MacMovieFile(final URL url) {
		super(url);
	}

	public MacMovieFile(final String url) throws MalformedURLException {
		super(url);
	}
