package net.anfoya.movie.download.javafx.entrypoint;
...
import net.anfoya.movie.download.javafx.ComponentBuilder;
import net.anfoya.movie.download.javafx.SearchPane;
import net.anfoya.movie.download.javafx.SearchTabs;
