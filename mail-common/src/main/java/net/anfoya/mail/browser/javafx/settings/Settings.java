...
public class Settings implements Serializable {
	...
	public static final String VERSION_TXT_URL = "https://speederpan.uk.to/jenkins/job/mail-client-distrib/lastSuccessfulBuild/artifact/mail-client-distrib/distrib/version.txt";
