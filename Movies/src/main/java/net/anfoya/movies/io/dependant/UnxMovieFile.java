...
public class UnxMovieFile extends AbstractMovieFile implements MovieFile {
	private static final Logger LOGGER = LoggerFactory.getLogger(UnxMovieFile.class);
	private static final String MOUNT_POINT_PREFIX = System.getProperty("user.home") + "/smb_";

	private static String mountPoint = null;

	public UnxMovieFile(final URL url) {
		super(url);
	}

	public UnxMovieFile(final String url) throws MalformedURLException {
		super(url);
	}
